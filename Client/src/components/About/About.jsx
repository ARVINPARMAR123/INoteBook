    ...
    <div className="about-page">
      <section className="about-section">
        ...
        <p>
          ...
          everyone whether you are a student, professional, or just jotting down
          ideas.
        </p>
      </section>
      ...
      <section className="privacy-section">
        ...
        <p>
          ...
          our servers all data stays in your browser storage unless you choose
          to export or share it.
        </p>
        <p>
          We only use your contact details to respond to your messages. We never
          share your data with third parties without your consent.
        </p>
        <p>
          For privacy concerns, contact us at:{" "}
          <strong>support@inotebook.app</strong>
        </p>
      </section>
    </div>
  );
