  ...
  return (
    <div className="home-container">
      <section className="hero-section">
        ...
        <h1>
          Welcome to <span className="brand">iNoteBook</span>
        </h1>
        <p>
          Your smart, secure cloud notebook organize thoughts, tasks, and ideas
          in one place.
        </p>
        <div className="hero-actions">
          <Link to={getStartedPath} className="btn hero-btn-primary">
            Get Started Free
          </Link>
          <Link to={signInPath} className="btn hero-btn-secondary">
            Sign In
          </Link>
        </div>
      </section>
      ...
      <section className="features-section">
        ...
        <p className="features-subtitle">
          Simple, powerful tools to keep you organized.
        </p>
        <div className="features-cards">
          <div className="feature-card">
            ...
            <h3>Create Notes</h3>
            <p>
              Add unlimited notes with titles, descriptions and custom tags.
            </p>
          </div>
          <div className="feature-card">
            ...
            <h3>Edit Anytime</h3>
            <p>
              Update your notes on the fly changes are saved to the cloud
              instantly.
            </p>
          </div>
          <div className="feature-card">
